...
/**
 * Funcao que produz pares sala / ocupação para os timestamp de admissão presentes no dataset
 *
 * @param params,val
 * @return
 */
...
/**
 * Funcao producer que vai distribuir os produtores enquanto a flag (prod_counter) for menor que o numero de salas
 * Funcao generica do problema produtor-consumidor, que usa 1 semaforo e 1 trinco
 * @param params
 * @return
 */
...
/**
 * Funcao consumer que vai distribuir os consumidores  enquanto a flag (cons_counter) for menor que o numero de salas
 * Funcao generica do problema produtor-consumidor, que usa 1 semaforo e 1 trinco
 * @return
 */
void* consumer(){
...
/**
 * Funcao que obtem o produto e escreve-o no output
 * @param prod 
 */
